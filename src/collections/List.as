package collections
{
	...
	public class List extends Collection
	{
		 ...
		 * 
		 * <p>
		 * If the starting index is a negative number, the starting point begins 
		 * at the end of the array, where -1 is the last element.
		 * </p>
		 * 
		 ...
		 * 	includes all elements from the starting point to the end of the array. 
